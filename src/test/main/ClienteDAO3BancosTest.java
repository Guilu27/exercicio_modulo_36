...
public class ClienteDAO3BancosTest {
    ...
    public void alterar() throws DAOException {
        ...
        testarAlterar(clienteDB3, iClienteDAODB3);
    }
    ...
    public void pesquisarTodos() throws DAOException {
        ...
        Cliente cliente1DB3 = criarCliente();
        Cliente cliente2DB3 = criarCliente();
        testarPesquisarTodos(cliente1DB3, cliente2DB3, iClienteDAODB3);
    }
